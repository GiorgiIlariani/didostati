...
const faqs: { q: string; a: string; icon: React.ReactNode }[] = [
  {
    q: "რა ღირს მიწოდება?",
    a: "მიწოდების თანხა განისაზრვრება პროდუქციის ღირებულებიდან და კატეგორიიდან გამომდინარე",
    icon: <Truck className="w-5 h-5 text-orange-400 shrink-0" />,
  },
  {
    q: "მასალა რომელი ქვენიდან არის შემოტანილი?",
    a: "მასალა შემოდის ირანიდან, თურქეთიდან, რუსეთიდან, ჩინეთიდან ასევე საქართველოში წარმოებული პროდუქტებიდან",
    icon: <CreditCard className="w-5 h-5 text-orange-400 shrink-0" />,
  },
  {
    q: "ფასდაკლება როგორ ხდება?",
    a: "ფასდაკლება განისაზღვრება პროდუქიის ღირებულებიდან და კატეგორიიდან გამომდინარე ან განმეორებითი შეკვეთებიდან.",
    icon: <Package className="w-5 h-5 text-orange-400 shrink-0" />,
  },
  {
    q: "რატომ უნდა გენდოთ?",
    a: "თანხას იხდით მხოლოდ მას შემდეგ რაც პროდუქცია მოვა თქვენს ადგილამდე და შემოწმებთ თითოეულ დეტალს ასე რომ დაზღვეული ბრძანდბით",
      ...
      <section className="relative py-16 md:py-20 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 relative">
          ...
          <p className="text-slate-400 text-lg max-w-xl">
            იპოვეთ პასუხები მიწოდებაზე, გადახდასა და შეკვეთებზე. კითხვა დარჩა?
            დაგვიკავშირდით.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="mt-14 md:mt-16 rounded-2xl border border-slate-700/80 bg-linear-to-br from-slate-800/80 to-slate-800/40 p-8 md:p-10 text-center shadow-xl shadow-black/20">
            ...
            <p className="text-slate-400 mb-8 max-w-md mx-auto">
              დაგვირეკეთ, გამოგვიგზავნეთ შეტყობინება ან დაგვიწერეთ WhatsApp-ით —
              პასუხობთ სწრაფად.
            </p>
