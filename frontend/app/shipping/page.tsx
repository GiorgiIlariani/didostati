      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-10">
          ...
          <p className="mt-3 text-slate-400 text-sm md:text-base leading-relaxed max-w-2xl">
            სამი მარტივი ნაბიჯი: აირჩიეთ ქალაქი რუკაზე ან სიიდან, შემდეგ
            მიუთითეთ გჭირდებათ თუ არა დიდი მანქანა — გიჩვენებთ ორიენტირებით
            ფასს. დეტალებზე დაგვირეკეთ ან გადადით კონტაქტის გვერდზე.
          </p>
        </header>
