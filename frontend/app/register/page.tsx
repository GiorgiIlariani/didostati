      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 rounded-2xl border border-slate-700 p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-slate-300 text-sm font-medium mb-2">სახელი</label>
            ...
            <div>
              <label className="block text-slate-300 text-sm font-medium mb-2">პაროლი (მინ. 6 სიმბოლო)</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-slate-300 text-sm font-medium mb-2">პაროლის გამეორება</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500" />
                <input
                  type="password"
          ...
          <p className="mt-6 text-center text-slate-400 text-sm">
            უკვე გაქვთ ანგარიში?{' '}
            <Link href={redirect !== '/' ? `/login?redirect=${encodeURIComponent(redirect)}` : '/login'} className="text-orange-400 hover:text-orange-300 font-medium">
              შესვლა
            </Link>
          </p>
        </div>
