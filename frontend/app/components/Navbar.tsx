    ...
    <>
      <nav className="relative z-50 w-full flex items-center justify-between border-b border-slate-700/50 shadow-lg px-4 md:px-6 lg:px-8 py-3 md:py-4 bg-slate-900 backdrop-blur-sm">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          ...
          {/* Notifications: loader while auth loads so icon doesn't hide/reappear */}
          {loading ? (
            <div
          ...
          <Link
            ...
            {loading || wishlistLoading ? (
              <span
                className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-slate-800 ring-2 ring-slate-900 flex items-center justify-center"
                aria-hidden>
          ...
          {/* Auth slot: loader while checking auth, then user menu or login */}
        ...
        <div className="md:hidden bg-slate-800 border-b border-slate-700 shadow-lg">
          <div className="px-4 py-3 space-y-2">
            ...
            <Link
              ...
              {!loading && !wishlistLoading && wishlistIds.length > 0 && (
